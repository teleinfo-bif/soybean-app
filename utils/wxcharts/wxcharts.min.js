...
function isInAngleRange(t, e, i) {
  ...
  return (
    ...
    (e = a(e)),
    (i = a(i)),
    e > i && ((i += 2 * Math.PI), t < e && (t += 2 * Math.PI)),
    t >= e && t <= i
  );
}
...
function fillSeriesColor(t, e) {
  ...
  return t.map(function(t) {
    return (
      t.color || ((t.color = e.colors[i]), (i = (i + 1) % e.colors.length)), t
    );
  });
}
  ...
  return (
    (i =
      a >= 1e4
        ...
        ? 0.1
        : 0.01),
    { minRange: findRange(t, "lower", i), maxRange: findRange(e, "upper", i) }
  );
}
  ...
  return (
    t.forEach(function(t) {
      if (null !== t.data[e] && void 0 !== t.data[e]) {
        ...
        (a.color = t.color),
          (a.name = t.name),
          (a.data = t.format ? t.format(t.data[e]) : t.data[e]),
          i.push(a);
      }
    }),
    i
...
function isInExactChartArea(t, e, i) {
  return (
    t.x < e.width - i.padding &&
    t.x > i.padding + i.yAxisWidth + i.yAxisTitleWidth &&
    t.y > i.padding &&
    t.y < e.height - i.legendHeight - i.xAxisHeight - i.padding
  );
}
function findRadarChartCurrentIndex(t, e, i) {
  ...
  if (isInExactPieChartArea(t, e.center, e.radius)) {
    var o = function(t) {
        return (
          t < 0 && (t += 2 * Math.PI), t > 2 * Math.PI && (t -= 2 * Math.PI), t
        );
      },
...
function findPieChartCurrentIndex(t, e) {
  ...
  if (isInExactPieChartArea(t, e.center, e.radius)) {
    ...
    for (var n = 0, o = e.series.length; n < o; n++) {
      var r = e.series[n];
      if (
        isInAngleRange(a, r._start_, r._start_ + 2 * r._proportion_ * Math.PI)
      ) {
        i = n;
        break;
      }
...
function calLegendData(t, e, i) {
  ...
  return (
    ...
    o.length && a.push(o),
    { legendList: a, legendHeight: a.length * (i.fontSize + 8) + 5 }
  );
}
    ...
    a.forEach(function(a) {
      ...
      (n.color = a.color),
        ...
        a.data.forEach(function(a, r) {
          ...
          (l.angle = t[r]),
            (l.proportion = a / s),
            (l.position = convertCoordinateOrigin(
              i * l.proportion * o * Math.cos(l.angle),
              i * l.proportion * o * Math.sin(l.angle),
              e
            )),
            n.data.push(l);
        }),
...
function getPieTextMaxLength(t) {
  ...
  return (
    t.forEach(function(t) {
      var i = t.format
        ? t.format(+t._proportion_.toFixed(2))
        : util.toFixed(100 * t._proportion_) + "%";
...
function fixColumeData(t, e, i, a, n, o) {
  return t.map(function(t) {
    return null === t
      ? null
      : ((t.width = (e - 2 * n.columePadding) / i),
        o.extra.column && o.extra.column.width && +o.extra.column.width > 0
          ? (t.width = Math.min(t.width, +o.extra.column.width))
          : (t.width = Math.min(t.width, 25)),
        (t.x += (a + 0.5 - i / 2) * t.width),
        t);
  });
}
function getXAxisPoints(t, e, i) {
  ...
  return (
    ...
    { xAxisPoints: s, startX: l, endX: h, eachSpacing: r }
  );
}
...
function getYAxisTextList(t, e, i) {
  ...
  if (
    ("number" == typeof e.yAxis.min && (n = Math.min(e.yAxis.min, n)),
    "number" == typeof e.yAxis.max && (o = Math.max(e.yAxis.max, o)),
    n === o)
  ) {
    var r = o || 1;
    (n -= r), (o += r);
...
function calYAxisData(t, e, i) {
  var a = getYAxisTextList(t, e, i),
    ...
    o = a.map(function(t) {
      return (
        (t = util.toFixed(t, 2)),
        (t = e.yAxis.format ? e.yAxis.format(Number(t)) : t),
        (n = Math.max(n, measureText(t) + 5)),
        t
      );
    });
  return (
    !0 === e.yAxis.disabled && (n = 0),
    { rangesFormat: o, ranges: a, yAxisWidth: n }
  );
}
  ...
  (e += n.radarLabelTextMargin),
    ...
    t.forEach(function(t, r) {
      ...
      util.approximatelyEqual(s.x, 0)
        ...
        : s.x < 0 && (h -= measureText(a.categories[r] || "")),
  ...
  t
    ...
    .forEach(function(t) {
      var e = Math.cos(t.arc) * r,
        ...
        f = d;
      l &&
        util.isSameXCoordinateArea(l.start, { x: c }) &&
        (f =
          c > 0
            ? Math.min(d, l.start.y)
            : e < 0
            ? Math.max(d, l.start.y)
            : d > 0
            ? Math.max(d, l.start.y)
            : Math.min(d, l.start.y)),
        c < 0 && (c -= x);
...
function drawToolTip(t, e, i, a, n) {
  ...
  e.x - Math.abs(i._scrollDistance_) + 8 + s > i.width && (o = !0),
    n.beginPath(),
    ...
    t.forEach(function(t, i) {
      ...
      var r = e.x + 8 + 2 * a.toolTipPadding,
        l =
          e.y +
          (a.toolTipLineHeight - a.fontSize) / 2 +
          a.toolTipLineHeight * i +
          a.toolTipPadding;
      o && (r = e.x - s - 8 + 2 * a.toolTipPadding),
  ...
  return (
    ...
    t.forEach(function(o, r) {
      var s = o.data,
        x = getDataPoints(s, c, d, l, h, e, i, n);
      (x = fixColumeData(x, h, t.length, r, i, e)),
        !1 !== e.dataLabel && 1 === n && drawPointText(x, o, i, a);
    }),
    a.restore(),
    { xAxisPoints: l, eachSpacing: h }
  );
}
function drawAreaDataPoints(t, e, i, a) {
  ...
  return (
    ...
    a.restore(),
    { xAxisPoints: l, calPoints: f, eachSpacing: h }
  );
}
function drawLineDataPoints(t, e, i, a) {
  ...
  return (
    ...
    a.restore(),
    { xAxisPoints: l, calPoints: x, eachSpacing: h }
  );
}
...
function drawYAxis(t, e, i, a) {
  if (!0 !== e.yAxis.disabled) {
    ...
    a.setFillStyle(e.background || "#ffffff"),
      e._scrollDistance_ < 0 && a.fillRect(0, 0, h, d + i.xAxisHeight + 5),
    ...
    a.stroke(),
      ...
      a.closePath(),
      a.stroke(),
      e.yAxis.title && drawYAxisTitle(e.yAxis.title, e, i, a);
  }
}
function drawLegend(t, e, i, a) {
  if (e.legend) {
    ...
    o.forEach(function(t, n) {
      ...
      var r = (e.width - o) / 2 + 5,
        s =
          e.height - i.padding - i.legendHeight + n * (i.fontSize + 8) + 5 + 8;
      a.setFontSize(i.fontSize),
        t.forEach(function(t) {
          switch (e.type) {
            case "line":
...
function drawPieDataPoints(t, e, i, a) {
  ...
  var r = { x: e.width / 2, y: (e.height - i.legendHeight) / 2 },
    s = Math.min(
      r.x -
        i.pieChartLinePadding -
        i.pieChartTextPadding -
        i._pieTextMaxLength_,
      r.y - i.pieChartLinePadding - i.pieChartTextPadding
    );
  if (
    (e.dataLabel ? (s -= 10) : (s -= 2 * i.padding),
    (t = t.map(function(t) {
    ...
    t.forEach(function(t) {
      a.beginPath(),
        ...
        a.closePath(),
        a.fill(),
        !0 !== e.disablePieStroke && a.stroke();
    }),
    "ring" === e.type)
  ) {
    var l = 0.6 * s;
    "number" == typeof e.extra.ringWidth &&
      e.extra.ringWidth > 0 &&
  ...
  return (
    1 === n && "ring" === e.type && drawRingTitle(e, i, a),
    { center: r, radius: s, series: t }
  );
}
function drawRadarDataPoints(t, e, i, a) {
  var n = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1,
    ...
    l = Math.min(
      s.x - (getMaxTextListLength(e.categories) + i.radarLabelTextMargin),
      s.y - i.radarLabelTextMargin
    );
  (l -= i.padding),
    a.beginPath(),
    a.setLineWidth(1),
    ...
    !(function(t) {
      ...
      a.beginPath(),
        ...
        r.forEach(function(n, o) {
          var r = convertCoordinateOrigin(
            (l / i.radarGridCount) * t * Math.cos(n),
            (l / i.radarGridCount) * t * Math.sin(n),
            s
          );
...
function drawCharts(t, e, i, a) {
  ...
  ("pie" !== t && "ring" !== t) ||
    (i._pieTextMaxLength_ = !1 === e.dataLabel ? 0 : getPieTextMaxLength(o));
  ...
  switch ((this.animationInstance && this.animationInstance.stop(), t)) {
      ...
      this.animationInstance = new Animation({
        ...
        onProcess: function(t) {
          ...
          var s = drawLineDataPoints(o, e, i, a, t),
            ...
            h = s.calPoints,
            c = s.eachSpacing;
          (n.chartData.xAxisPoints = l),
            (n.chartData.calPoints = h),
            (n.chartData.eachSpacing = c),
            drawXAxis(r, e, i, a),
    ...
    case "pie":
      this.animationInstance = new Animation({
        ...
        duration: u,
        onProcess: function(t) {
          (n.chartData.pieData = drawPieDataPoints(o, e, i, a, t)),
            drawLegend(e.series, e, i, a),
            drawCanvas(e, a);
        },
        onAnimationFinish: function() {
    ...
    case "radar":
      this.animationInstance = new Animation({
        ...
        duration: u,
        onProcess: function(t) {
          (n.chartData.radarData = drawRadarDataPoints(o, e, i, a, t)),
            drawLegend(e.series, e, i, a),
            drawCanvas(e, a);
        },
        onAnimationFinish: function() {
...
var Charts = function(t) {
  ...
  var e = assign({}, config);
  (e.yAxisTitleWidth =
    !0 !== t.yAxis.disabled && t.yAxis.title ? e.yAxisTitleWidth : 0),
    (e.pieChartLinePadding = !1 === t.dataLabel ? 0 : e.pieChartLinePadding),
    (e.pieChartTextPadding = !1 === t.dataLabel ? 0 : e.pieChartTextPadding),
    (this.opts = t),
    (this.config = e),
    (this.context = wx.createCanvasContext(t.canvasId, t.componentInstance)),
    (this.chartData = {}),
    (this.event = new Event()),
    (this.scrollOption = { currentOffset: 0, startTouchX: 0, distance: 0 }),
  ...
  (Charts.prototype.getCurrentDataIndex = function(t) {
    ...
    if (e && e.length) {
      ...
      return "pie" === this.opts.type || "ring" === this.opts.type
        ? findPieChartCurrentIndex({ x: a, y: n }, this.chartData.pieData)
