...
Page({
  ...
  addManager(managerId,type){
    ...
    if(type == '0'){
      wx.request({
        url: baseURL + '/wx/group/manager?groupId=' + that.data.groupId + '&userId=' + app.globalData.userFilledInfo.id + '&managerId=' + managerId,
        data: {
...
/*           console.log('data:' + res.data);
      ...
      wx.request({
        url: baseURL + '/wx/group/dataManager?groupId=' + that.data.groupId + '&userId=' + app.globalData.userFilledInfo.id + '&managerId=' + managerId,
        data: {
